...
<br>
  <div v-if="notyet == false" style="width: 200px;height: 200px;margin: 0 auto;" :style="{'display':openClose}">
    <qrcode-stream v-if="camera == true" @decode="onDecode" :style="{'display':openClose}">
      <div v-show="showScanConfirmation" class="scan-confirmation">
      </div>
    </qrcode-stream>
    <p>Scanning your QR Code...</p>
</div>

<div v-if="notyet == true" style="width: 200px;height: 200px;margin: 0 auto;" :style="{'display':openClose}">
  <img :style="{'width':'150px'}" src="../assets/x.png">
  <h1 style="color: red;">No logs found</h1>
</div>

<div v-if="scannedContent.eventDate != null && openClose == 'none'">
...
<br>
<div v-if="scannedContent.eventDate != null && openClose == 'none'" style="text-align: left;">
...
<img v-if="loader == 'inline-block'" :style="{'width':'150px'}" src="../assets/webDefaultLoading.gif">
<!-- <img v-if="scannedContent.employeename2 == null && loader == 'none'" style="width:200px; margin-top: 20px;" src="../assets/barcode-scan.png"> -->

<h2 v-if="openClose == 'none' && scannedContent.eventDate == null" >Event Viewer</h2>
...
<div class="scrollmenu" v-if="scannedContent.eventDate != null">
...
<button v-if="scannedContent.eventDate  == null && openClose == 'none'" @click="openCamera()" style="background-color: #4caf50; border: none;border-radius: 5px;font-size: large;color: white;padding: 10px;padding-left: 20px;padding-right: 20px;" > Scan QR Code</button>
<button v-if="scannedContent.eventDate != null" @click="webReset()" style="background-color: #4caf50; border: none;border-radius: 5px;font-size: large;color: white;padding: 10px;padding-left: 20px;padding-right: 20px;" :style="{'position':'absolute','bottom':'50px','left':'2px'}"> Rescan</button>
